  ...
  return (
    ...
    <div className='car'>
      ...
      <div className='lin'></div>
        <div className='card'>
          <img className='im'  src= {data[10].ImageAsset} alt='' height="200px" />
          <div className='data'>
            <h6> { data[10].PublishedDate} </h6>
            <h6> {data[10].Title} </h6>
            <h6> { data[10].BlogContent} </h6>
            <h6><h6> {data[10].Likes} </h6></h6>
          </div>
        </div>
        <div className='lin'></div>
        <div className='card'>
          <img className='im'  src= {data[11].ImageAsset} alt='' height="200px" />
          <div className='data'>
        ...
        <div className='lin'></div>
        <div className='card'>
          <img className='im'  src= {data[12].ImageAsset} alt='' height="200px" />
          <div className='data'>
            <h6> { data[12].PublishedDate} </h6>
            <h6> {data[12].Title} </h6>
            <h6> { data[12].BlogContent} </h6>
            <h6><h6> {data[12].Likes} </h6></h6>
          </div>
        </div>
        <div className='lin'></div>
        <div className='card'>
