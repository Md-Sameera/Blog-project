...
const Bollywood = () => {
  ...
  return (
    ...
    <div><h1>--------BOLLYWOOD-------</h1></div>
    <div className='car'>
   
      <div className='cards'>
      <div className='lin'></div>
        <div className='card'>
            <img className='im' src={data[3].ImageAsset} alt='' height="200px" />
        ...
        <div className='lin'></div>
        <div className='card'>
          <img className='im'  src= {data[1].ImageAsset} alt='' height="200px" />
          <div className='data'>
            <h6> { data[1].PublishedDate} </h6>
            <h6> {data[1].Title} </h6>
            <h6> { data[1].BlogContent} </h6>
            <h6><h6> {data[1].Likes} </h6></h6>
          </div>
        </div>
        <div className='lin'></div>
        <div className='card'>
          <img className='im'  src={data[2].ImageAsset} alt='' height="200px" />
          <div className='data'>
            <h6> { data[2].PublishedDate} </h6>
            <h6> {data[2].Title} </h6>
            <h6> { data[2].BlogContent} </h6>
            <h6><h6> {data[2].Likes} </h6></h6>
          </div>
        </div>
        <div className='lin'></div>
        <div className='card'>
